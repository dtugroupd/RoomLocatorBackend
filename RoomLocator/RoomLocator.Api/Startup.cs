...
{
    /// <summary>
    ///     Initializes the entire project. Some is autogenerated, some is modified
    ///     <author>Anders Wiberg Olsen, s165241</author>
    ///     <author>Almost everybody working on backend have contributes in some way to this</author>
    /// </summary>
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddScoped<PeoplecounterService, PeoplecounterService>();

            services.Configure<ApiBehaviorOptions>(options => {
                options.InvalidModelStateResponseFactory = InvalidModelHandler.HandleInvalidModelAggregate;
            });

            #region Autogenerated Swagger Documentation, Anders Wiberg Olsen, s165241
